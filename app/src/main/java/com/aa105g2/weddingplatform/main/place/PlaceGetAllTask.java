...
public class PlaceGetAllTask extends AsyncTask<Object, Integer, List<PlaceVO>> {
    private final static String TAG = "PlaceGetAllTask";
    private final static String ACTION = "PlaceGetAllInfo";
