...
/**
 * Created by cuser on 2017/1/3.
 */

public class AppointmentListGetAllTask extends AsyncTask<Object, Integer, List<AppointmentVO>> {
    private final static String TAG = "AppointmentListGetAllTask";
    private final static String ACTION = "AppointmentListGetAll";
