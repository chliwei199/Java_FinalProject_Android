...
public class PhotoGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "PhotoGetImageTask";
    private final static String ACTION = "getPhotoImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    public PhotoGetImageTask(ImageView imageView) {
        this.imageViewWeakReference = new WeakReference<>(imageView);
    }

    @Override
    protected Bitmap doInBackground(Object... params) {
        String url = params[0].toString();           //get Common.URL + "PhotoServletForApp"
        String photo_no = params[1].toString();        //get place_no , imageSize
        ...
        jsonObject.addProperty("photo_no", photo_no);   //talk servlet I want get place_no picture
