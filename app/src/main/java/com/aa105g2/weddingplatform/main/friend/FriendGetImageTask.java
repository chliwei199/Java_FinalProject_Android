...
import java.net.URL;
public class FriendGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "FriendGetImageTask";
    private final static String ACTION = "getFriendImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    public FriendGetImageTask(ImageView imageView) {
