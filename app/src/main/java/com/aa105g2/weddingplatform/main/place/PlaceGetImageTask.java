...
public class PlaceGetImageTask extends AsyncTask<Object, Integer, Bitmap> {
    private final static String TAG = "PlaceGetImageTask";
    private final static String ACTION = "getAllImage";
    private final WeakReference<ImageView> imageViewWeakReference;

    PlaceGetImageTask(ImageView imageView) {
        this.imageViewWeakReference = new WeakReference<>(imageView);
    }

    @Override
    protected Bitmap doInBackground(Object... params) {
        String url = params[0].toString();           //get Common.URL + "PlaceServlet"

//        int id = Integer.parseInt(params[1].toString());
        String place_no = params[1].toString();        //get place_no , imageSize
        ...
        jsonObject.addProperty("place_no", place_no);   //talk servlet I want get place_no picture
